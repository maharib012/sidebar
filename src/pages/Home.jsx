...
const Home = () => {
    ...
    return (
        <section className="flex gap-6">
            <div className={`min-h-screen bg-[#0e0e0e] ${open ? "w-72" : "w-16"} duration-500 text-white px-4`}>
                ...
                <div className="mt-4 flex flex-col gap-4 relative">
                    {
                        menus.map((menu, i) => (
                            <Link key={i} to={menu.link} className={`group flex items-center text-sm font-medium gap-x-3.5 p-2 hover:bg-gray-800 rounded-md ${menu.margin && "mt-5"}`}>
